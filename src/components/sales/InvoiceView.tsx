          ...
          <CardContent className="space-y-5 pt-6">
            ...
            <div className="grid gap-4 text-sm md:grid-cols-2">
              <div className="print-avoid-break space-y-1">
                ...
                {customer?.gstin && (
                  <p className="text-muted-foreground">{t("customers.gstin")}: {customer.gstin}</p>
                )}
              </div>
              <PrintMeta
              ...
              rows={
                isQuote
                  ? [
                      ...
                      { label: t("common.tax"), value: formatCurrency(order.tax) },
              ...
              <CardContent className="space-y-3 pt-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    disabled={due <= 0 || order.status === "cancelled"}
                  />
                </div>
                <div className="space-y-1.5">
